...
export default function HomeClient() {
    ...
    return (
        <div className="relative w-full min-h-[100dvh] bg-gray-950 font-outfit overflow-x-hidden">
            ...
            {/* Centered Content Wrapped in Scrollable Container */}
            <div className="relative z-10 w-full min-h-[100dvh] flex flex-col items-center px-6 text-center">
                {/* Fixed Spacer for Header (56px approx + padding) to avoid overlap with dynamic header */}
                ...
                <motion.div
                    ...
                    className="w-full max-w-4xl flex-1 flex flex-col items-center justify-between pb-12"
                >
                    {/* Top flexible space for vertical centering */}
                    <div className="w-full flex-1 flex flex-col justify-center items-center py-10 mt-10 md:mt-0">
                        {/* Main Navigation */}
                        <nav
                            className="flex flex-col sm:flex-row justify-center items-center gap-12 sm:gap-20 md:gap-32 mb-20 sm:mb-28"
                        >
                            <motion.a
                    ...
                    {/* Slogan at Bottom */}
                    <div className="space-y-6 mt-16 sm:mt-24 w-full flex flex-col items-center text-center">
                        <motion.p
                            animate={{ opacity: isAnyHovered ? 0.7 : 1 }}
                            className="text-base sm:text-lg md:text-xl text-white font-light leading-relaxed tracking-tight transition-opacity duration-1000 max-w-2xl md:max-w-3xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]"
                        >
